...
function S(n2, l3, u3, t3, i3, o3, r3, f3, e3, c3, s3) {
  ...
  for (u3.__d = e3, $(u3, l3, _2), e3 = u3.__d, a3 = 0; a3 < g2; a3++) null != (y3 = u3.__k[a3]) && "boolean" != typeof y3 && "function" != typeof y3 && (v3 = -1 === y3.__i ? h : _2[y3.__i] || h, y3.__i = a3, O(n2, y3, v3, i3, o3, r3, f3, e3, c3, s3), d3 = y3.__e, y3.ref && v3.ref != y3.ref && (v3.ref && N(v3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 65536 & y3.__u || v3.__k === y3.__k ? (e3 && "string" == typeof y3.type && !n2.contains(e3) && (e3 = x(v3)), e3 = I(y3, e3, n2)) : "function" == typeof y3.type && void 0 !== y3.__d ? e3 = y3.__d : d3 && (e3 = d3.nextSibling), y3.__d = void 0, y3.__u &= -196609);
  u3.__d = e3, u3.__e = w3;
}
function $(n2, l3, u3) {
...
function Header(props) {
  return /* @__PURE__ */ _("header", null, /* @__PURE__ */ _("h1", null, props.title));
}

// source/components/switch.tsx
function Switch({ value, defaultCase = null, cases }) {
  if (value == null) return null;
  return /* @__PURE__ */ _(k, null, cases[value] != null ? cases[value] : defaultCase);
}
...
// source/hooks/use_route.ts
function useRoute() {
  const [route, setRoute] = h2(location.hash);
  y2(() => {
...
// source/utilities/storage_helpers.ts
var { storage } = mod_default;
var KEY = "storage_key";
...
async function getStorage() {
  const data = await storage.sync.get(KEY);
  return data[KEY];
}
...
function Home(_props) {
  ...
  return /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("h1", null, "It feels like home"), /* @__PURE__ */ _("a", { href: "#options" }, "go to options"), /* @__PURE__ */ _("h3", null, "Stored String: ", display), /* @__PURE__ */ _(
    "input",
    {
      placeholder: display,
      onChange: q2((e3) => {
    ...
    "button",
    {
      onClick: q2(() => updateStorage(inputData), [inputData])
    },
    "Update Storage"
  ));
}

// source/pages/options.tsx
function Options(_props) {
  return /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("h1", null, "It feels like... options?"), /* @__PURE__ */ _("a", { href: "#home" }, "go to home"));
}
...
function App() {
  return /* @__PURE__ */ _("main", null, /* @__PURE__ */ _(Header, { title: "Browser Extension Boilerplate" }), /* @__PURE__ */ _(
    Switch,
    {
      value: useRoute(),
      defaultCase: /* @__PURE__ */ _(Home, { default: true, path: "/home" }),
      cases: {
        "#options": /* @__PURE__ */ _(Options, { path: "/options" })
      }
    }
  ));
}
